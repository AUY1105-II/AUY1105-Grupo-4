...
### Añadido
- Directorio `policies/` con políticas Zero Trust en Rego (`rules.rego`) para auditar cierre de puerto SSH a todo internet y forzar uso de instancia `t2.micro`.
- Tests unitarios automatizados (`rules_test.rego`) para validación de políticas OPA en CI/CD.
...
- Incorporación de pruebas mediante pipeline en archivo iac-pr.yaml
